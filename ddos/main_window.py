...
.. module:: app
    :platform: Unix
    :synopsis: This module provide all classes for the main window

.. moduleauthor: louis laporte <louis.laporte12@gmail.com>
...
import pandas as pd
import sys
from ddos.menu import *
import ddos.util.extract
...
class ToolBar(QToolBar):
    ...
    @staticmethod
    def icon_name(path='./ddos/resources/icons', name=None):
